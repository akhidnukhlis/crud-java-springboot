...
import akhidnukhlis.crudspringapi.model.RegisterUserRequest;
import akhidnukhlis.crudspringapi.model.UpdateUserRequest;
import akhidnukhlis.crudspringapi.model.UserResponse;
...
class UserControllerTest {
    ...
    void updateUserSuccess() throws Exception {
        ...
        UpdateUserRequest request = new UpdateUserRequest();
        request.setName("Akhid");
        request.setPassword("akhid0000");
        ...
        mockMvc.perform(
            ...
            assertNull(response.getErrors());
            assertEquals("Akhid", response.getData().getName());
            assertEquals("test", response.getData().getUsername());

            User userDb = userRepository.findById("test").orElse(null);
            assertNotNull(userDb);
            assertTrue(BCrypt.checkpw("akhid0000", userDb.getPassword()));
        });
    }
}